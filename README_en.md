...
<p align="center">
  <a href="https://github.com/ezer-coder/wechat-kimi-code/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green?style=flat-square" alt="License: MIT"></a>
  <a href="https://skills.sh/ezer-coder/wechat-kimi-code"><img src="https://img.shields.io/badge/skills.sh-view_page-blue?style=flat-square" alt="skills.sh"></a>
...
> About **60% of enterprise AI spend goes to tasks that don't need top-tier models.**
> — Cursor Router team, based on millions of production requests (July 2026)
...
- **Cache-Aware Routing** — On borderline signals, stays on the previous turn's model to maximize prompt cache hit rate (saves up to 90% on input token costs with Anthropic/OpenAI caching)
- **Dynamic Upgrade** — Tracks conversation complexity trend; auto-upgrades to strong model when 3 consecutive messages show increasing complexity above threshold
- **Sticky + Auto-Downgrade** — Locks to strong model after upgrade; drops back to fast model after 3 consecutive casual messages

Configuration (`~/.wechat-claude-code/routing.json`):
...
```json
{
  ...
  "cacheAware": true,
  "sticky": true,
  "models": { "fast": "potluck/fast", "strong": "potluck/code" }
}
```
